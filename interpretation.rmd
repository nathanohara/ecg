...
for (i in 1:12){
  ...
  print(comb_data %>%
    ggplot() + 
      geom_density(aes(x=alpha, fill = label), alpha = 0.5) + 
      xlab(paste("alpha_",i,sep="")) + 
...
for (i in 1:17){
  ...
  print(comb_data %>%
    ggplot() + 
      geom_density(aes(x=delta, fill = label), alpha = 0.5) + 
      xlab(paste("delta_",i,sep="")) + 
      theme(legend.position = "none", 
            axis.title.x = element_text(face = "bold", size = 16),
            axis.title.y = element_text(size = 16),
            axis.text = element_text(size = 16))
...
comb_data %>%
  ggplot() + 
  geom_density(aes(x=beta, fill = label), alpha = 0.5) + 
  theme(legend.position = "none", 
        axis.title.x = element_text(face = "bold", size = 16),
        axis.title.y = element_text(size = 16),
        axis.text = element_text(size = 16))
